...
<div id="details">
    <div class="tabs" style="flex: 1 1 auto; height: 100%;">
        ...
        <div>
            <h5>Templates</h5>
            <div id="templates" class="keepsize">
                <div class="draggable" draggable="false" data-template="addnew" style="cursor: pointer;">
                ...
                <div class="draggable" draggable="false" data-template="remove" style="cursor: pointer;">
...
foreach ($files as $file) {
    ...
    $displayName = ucfirst($templateName);
